...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun May 11 14:49:10 CST 2014
  */
...
public void imprimirtablaDeSimbolo(){
        System.out.println("-------------------------------------");
        System.out.println("---------Tabla De Simbolo 3----------");
        ...
        while (e.hasMoreElements()) {  
                ...
                s=tabla.get(obj);
                System.out.println(" key "+ obj +": "+ s.getTipos() + ", "+ s.getAmbito());  
        }    
        System.out.println("-------------------------------------");
}
...
public String getTipos(String nombre, int ambito,int linea,int columna){
String id
String id2
String n="";
    ...
    Simbolos sim = new Simbolos();
     ...
     else
     {
            if ((Simbolos)tabla.get(id2) != null){
                ...
                n="integer" ;  /// ojo ver que retornamos
